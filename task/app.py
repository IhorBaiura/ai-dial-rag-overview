...
INPUT_FILE_PATH = "task/microwave_manual.txt"
FAISS_INDEX_PATH = "task/microwave_faiss_index"
...
class MicrowaveRAG:
    ...
    def _create_new_index(self) -> VectorStore:
        ...
        loader = TextLoader(file_path=INPUT_FILE_PATH, encoding="utf-8")
        documents = loader.load()
        print(f"Loaded {len(documents)} documents from {INPUT_FILE_PATH}.")
        ...
        print("Creating vectorstore from chunks...")
    ...
    def retrieve_context(self, query: str, k: int = 6, score: float = 0.5) -> str:
        """
